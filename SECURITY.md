...
Dhwani is an **educational and demonstration project**. It is not designed or audited for production-grade security. Use at your own discretion.
...
If you deploy Dhwani beyond local development, you are responsible for:
...
2. Email **security@ApexAI.com** with details
3. Include steps to reproduce and potential impact
4. We will acknowledge receipt within 48 hours

Thank you for helping keep Dhwani safe.
